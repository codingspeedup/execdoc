...
public class BlueprintManagerGUI<B extends Blueprint<?>> extends JFrame {
    ...
    private final Class<B> bpType;
    private final List<BlueprintManagerListener<B>> listeners = new ArrayList<>();
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    @SneakyThrows
    public BlueprintManagerGUI(Class<B> bpType, File initialLocation) {
    ...
    public void addListener(BlueprintManagerListener<B> listener) {
    ...
    private void generateProject(ActionEvent actionEvent) {
        ...
        try {
            for (BlueprintManagerListener<B> listener : listeners) {
                listener.onGenerate(getBlueprint());
            }
